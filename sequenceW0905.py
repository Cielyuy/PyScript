...
Specified_Dir_preffix_1 =os.path.join("task" ,"0903_7" )
...
# linux_content_preffix_1 = '/public/home/hpc184212120/ZTC/ansys19/v192/fluent/bin/fluent  -g  3d  -t96 -wait -cnf=$hostlist   -mpi=intel -i '
##linux_content_preffix_1 = '/public/home/hpc184201023/SoftwarePackage/ansys19/v192/fluent/bin/fluent  -g  3d  -t16 -wait -cnf=$hostlist   -mpi=intel -i '
...
for k in catchList:
    ...
    C_Now_Pic = os.path.join(Clip_Whole_Dir,Specified_Dir,(cfdpostDataName + ".png"))
    ...
    J_Now_Cas =os.path.join(Clip_Whole_Dir,Specified_Dir,(FluentDataName + '.cas.gz'))

    J_Previous_Stored_Pic = 'FluentData_M317__52_1800jpg'
    J_Now_Pic = os.path.join(Clip_Whole_Dir,Specified_Dir,(FluentDataName + '.png'))
    
    ##改变监测点文件的输出位置：
    
    J_Previous_IterateNum = r'/solve/iterate 20000'
    J_Now_IterateNum = r'/solve/iterate '+ str(IterateNum)
    #####
    #####变化的量
    ...
    J_find_str_ls = [J_Previous_Stored_Mesh, J_Previous_Stored_Cas, J_Previous_Stored_Pic,J_Previous_Var,J_Previous_varNum,J_Previous_IterateNum]  ##################更换匹配字符
    J_replace_str_ls = [J_Now_mesh, J_Now_Cas, J_Now_Pic, J_Now_Var,J_Now_varNum,J_Now_IterateNum]  ##################
...
# os.system('sbatch '+os.path.join(Clip_Whole_Dir,Specified_Dir,'B_linuxDocu.sh') )
